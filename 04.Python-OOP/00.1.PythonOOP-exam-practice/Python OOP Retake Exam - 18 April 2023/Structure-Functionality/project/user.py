...
class User:
    ...
    def first_name(self, value):
        validate_parameter(value, "First name cannot be empty!")
    ...
    def last_name(self, value):
        validate_parameter(value, "Last name cannot be empty!")
    ...
    def driving_license_number(self, value):
        validate_parameter(value, "Driving license number is required!")
