# Generated by Django 5.0.4 on 2024-07-22 19:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.DecimalField(decimal_places=1, max_digits=2, validators=[main_app.validators.RangeValueValidator(0.0, 10.0, message='The rating must be between 0.0 and 10.0')])),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
